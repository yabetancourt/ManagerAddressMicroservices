...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = {
            CenterAuthorizationNotFoundException.class,
    ...
    protected ResponseEntity<Object> handleOptimisticLocking(RuntimeException ex, WebRequest request) {
        String errorMessage = "Error: Another user has modified this entity since you last loaded it. Please reload the data and try again.";
